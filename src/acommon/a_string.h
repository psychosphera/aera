...
EXTERN_C str_t A_str(const string_t* s);

EXTERN_C string_t A_string_Str   (const str_t*    s);
EXTERN_C string_t A_string_String(const string_t* s);
...
EXTERN_C const char* A_cstr_Str    (const str_t*    s);
EXTERN_C       char* A_cstr_String (      string_t* s);
EXTERN_C const char* A_cstr_StringC(const string_t* s);
...
EXTERN_C char A_strat_Str   (const str_t*    s, size_t i);
EXTERN_C char A_strat_String(const string_t* s, size_t i);
...
EXTERN_C const char* A_stratp_Str    (const str_t*    s, size_t i);
EXTERN_C       char* A_stratp_String (      string_t* s, size_t i);
EXTERN_C const char* A_stratp_StringC(const string_t* s, size_t i);
...
EXTERN_C size_t A_strlen_Str   (const str_t*    s);
EXTERN_C size_t A_strlen_String(const string_t* s);
...
EXTERN_C size_t A_strcap(const string_t* s);
...
EXTERN_C string_t A_strdup_Str   (const str_t*    s);
EXTERN_C string_t A_strdup_String(const string_t* s);
...
EXTERN_C bool A_strext (string_t* s, size_t n);
EXTERN_C bool A_strpush(string_t* s, char   c);

EXTERN_C bool A_strshrnk(string_t* s, size_t n);
EXTERN_C char A_strpop  (string_t* s);

EXTERN_C bool A_strcat_Str   (string_t* dest, const str_t*    src);
EXTERN_C bool A_strcat_String(string_t* dest, const string_t* src);
...
#else
inline bool A_strcat(string_t* dest, const str_t* src) { 
    return A_strcat_Str(dest, src); 
} 
inline bool A_strcat(string_t* dest, const string_t* src) { 
    return A_strcat_String(dest, src); 
} 
#endif

EXTERN_C size_t A_strchr_Str   (const str_t*    s, char c);
EXTERN_C size_t A_strchr_String(const string_t* s, char c);
...
EXTERN_C size_t A_strrchr_Str   (const str_t*    s, char c);
EXTERN_C size_t A_strrchr_String(const string_t* s, char c);
...
EXTERN_C bool A_strcont_Str   (const str_t*    s, char c);
EXTERN_C bool A_strcont_String(const string_t* s, char c);
...
#else
inline bool A_strcont(const str_t* s, char c) { 
    return A_strcont_Str(s, c); 
} 
inline bool A_strcont(const string_t* s, char c) { 
    return A_strcont_String(s, c); 
} 
#endif // __cplusplus

EXTERN_C bool A_streq_Str_Str      (const str_t*    a, const str_t*    b);
EXTERN_C bool A_streq_Str_String   (const str_t*    a, const string_t* b);
EXTERN_C bool A_streq_String_Str   (const string_t* a, const str_t*    b);
EXTERN_C bool A_streq_String_String(const string_t* a, const string_t* b);
...
EXTERN_C size_t A_strpbrk_Str_Str      (const str_t*    a, const str_t*    b);
EXTERN_C size_t A_strpbrk_Str_String   (const str_t*    a, const string_t* b);
EXTERN_C size_t A_strpbrk_String_Str   (const string_t* a, const str_t*    b);
EXTERN_C size_t A_strpbrk_String_String(const string_t* a, const string_t* b);
...
#else
inline size_t A_strpbrk(const str_t* a, const str_t* b) { 
    return A_strpbrk_Str_Str(a, b); 
}
inline size_t A_strpbrk(const str_t* a, const string_t* b) { 
    return A_strpbrk_Str_String(a, b); 
}
inline size_t A_strpbrk(const string_t* a, const str_t* b) { 
    return A_strpbrk_String_Str(a, b); 
}
inline size_t A_strpbrk(const string_t* a, const string_t* b) { 
    return A_strpbrk_String_String(a, b); 
}
#endif // __cplusplus

EXTERN_C size_t A_strrpbrk_Str_Str      (const str_t*    a, const str_t*    b);
EXTERN_C size_t A_strrpbrk_Str_String   (const str_t*    a, const string_t* b);
EXTERN_C size_t A_strrpbrk_String_Str   (const string_t* a, const str_t*    b);
EXTERN_C size_t A_strrpbrk_String_String(const string_t* a, const string_t* b);
...
#else
inline size_t A_strrpbrk(const str_t* a, const str_t* b) { 
    return A_strrpbrk_Str_Str(a, b); 
}
inline size_t A_strrpbrk(const str_t* a, const string_t* b) { 
    return A_strrpbrk_Str_String(a, b); 
}
inline size_t A_strrpbrk(const string_t* a, const str_t* b) { 
    return A_strrpbrk_String_Str(a, b); 
}
inline size_t A_strrpbrk(const string_t* a, const string_t* b) { 
    return A_strrpbrk_String_String(a, b); 
}
#endif // __cplusplus

EXTERN_C size_t A_strpcnt_Str_Str      (const str_t*    a, const str_t*    b);
EXTERN_C size_t A_strpcnt_Str_String   (const str_t*    a, const string_t* b);
EXTERN_C size_t A_strpcnt_String_Str   (const string_t* a, const str_t*    b);
EXTERN_C size_t A_strpcnt_String_String(const string_t* a, const string_t* b);
...
#else
inline size_t A_strpcnt(const str_t* a, const str_t* b) { 
    return A_strpcnt_Str_Str(a, b); 
}
inline size_t A_strpcnt(const str_t* a, const string_t* b) { 
    return A_strpcnt_Str_String(a, b); 
}
inline size_t A_strpcnt(const string_t* a, const str_t* b) { 
    return A_strpcnt_String_Str(a, b); 
}
inline size_t A_strpcnt(const string_t* a, const string_t* b) { 
    return A_strpcnt_String_String(a, b); 
}
#endif // __cplusplus

EXTERN_C size_t A_strrpcnt_Str_Str      (const str_t*    a, const str_t*    b);
EXTERN_C size_t A_strrpcnt_Str_String   (const str_t*    a, const string_t* b);
EXTERN_C size_t A_strrpcnt_String_Str   (const string_t* a, const str_t*    b);
EXTERN_C size_t A_strrpcnt_String_String(const string_t* a, const string_t* b);
...
#else
inline size_t A_strrpcnt(const str_t* a, const str_t* b) { 
    return A_strrpcnt_Str_Str(a, b); 
}
inline size_t A_strrpcnt(const str_t* a, const string_t* b) { 
    return A_strrpcnt_Str_String(a, b); 
}
inline size_t A_strrpcnt(const string_t* a, const str_t* b) { 
    return A_strrpcnt_String_Str(a, b); 
}
inline size_t A_strrpcnt(const string_t* a, const string_t* b) { 
    return A_strrpcnt_String_String(a, b); 
}
#endif // __cplusplus

EXTERN_C size_t A_strstr_Str_Str      (const str_t*    a, const str_t*    b);
EXTERN_C size_t A_strstr_Str_String   (const str_t*    a, const string_t* b);
EXTERN_C size_t A_strstr_String_Str   (const string_t* a, const str_t*    b);
EXTERN_C size_t A_strstr_String_String(const string_t* a, const string_t* b);
...
#else
inline size_t A_strstr(const str_t* a, const str_t* b) { 
    return A_strstr_Str_Str(a, b); 
}
inline size_t A_strstr(const str_t* a, const string_t* b) { 
    return A_strstr_Str_String(a, b); 
}
inline size_t A_strstr(const string_t* a, const str_t* b) { 
    return A_strstr_String_Str(a, b); 
}
inline size_t A_strstr(const string_t* a, const string_t* b) { 
    return A_strstr_String_String(a, b); 
}
#endif // __cplusplus

EXTERN_C size_t A_strrstr_Str_Str      (const str_t*    a, const str_t*    b);
EXTERN_C size_t A_strrstr_Str_String   (const str_t*    a, const string_t* b);
EXTERN_C size_t A_strrstr_String_Str   (const string_t* a, const str_t*    b);
EXTERN_C size_t A_strrstr_String_String(const string_t* a, const string_t* b);
...
#else
inline bool A_strrstr(const str_t* a, const str_t* b) { 
    return A_strrstr_Str_Str(a, b); 
}
inline bool A_strrstr(const str_t* a, const string_t* b) { 
    return A_strrstr_Str_String(a, b); 
}
inline bool A_strrstr(const string_t* a, const str_t* b) { 
    return A_strrstr_String_Str(a, b); 
}
inline bool A_strrstr(const string_t* a, const string_t* b) { 
    return A_strrstr_String_String(a, b); 
}
#endif // __cplusplus

EXTERN_C str_t A_substr_Str   (const str_t*    s, size_t i);
EXTERN_C str_t A_substr_String(const string_t* s, size_t i);
...
#else
inline str_t A_substr(const str_t* s, size_t i) { 
    return A_substr_Str(s, i); 
}
inline str_t A_substr(const string_t* s, size_t i) { 
    return A_substr_String(s, i); 
}
#endif // __cplusplus

EXTERN_C string_t A_substring_Str   (const str_t*    s, size_t i);
EXTERN_C string_t A_substring_String(const string_t* s, size_t i);
...
#else
inline string_t A_substring(const str_t* s, size_t i) { 
    return A_substring_Str(s, i); 
}
inline string_t A_substring(const string_t* s, size_t i) { 
    return A_substring_String(s, i); 
}
#endif // __cplusplus

EXTERN_C void A_strclear(string_t* s);
EXTERN_C void A_strdrop(string_t* s);

...
A_EXTERN_C A_NO_DISCARD void*       DB_LoadFont        (const char* font_name, A_OUT size_t* sz);
...
A_EXTERN_C              void        DB_UnloadMap_Stream(A_INOUT StreamFile* stream);
A_EXTERN_C A_NO_DISCARD FileMapping DB_LoadMap_Mmap    (const char* map_name);
A_EXTERN_C              void        DB_UnloadMap_Mmap  (A_INOUT FileMapping* map);
